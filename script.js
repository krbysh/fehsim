...
map.tiles = [
    ...
    [TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER],
    [TERRAIN_PLAIN, TERRAIN_MNTIN, TERRAIN_WATER, TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_PLAIN],
    [TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_PLAIN],
    [TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_WATER, TERRAIN_PLAIN],
    [TERRAIN_PLAIN, TERRAIN_PLAIN, TERRAIN_TREES, TERRAIN_WATER, TERRAIN_TREES, TERRAIN_PLAIN],
    [TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER],
    [TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER, TERRAIN_WATER]
]
...
map.backgroundPatternUri = 'res/img/maps/common/WavePattern.png';
map.foregroundImageUri = 'res/img/maps/common/CloudAdd.png';
>>>>>>> 4d5d826ce1a89f980c8ee0ecd273dcc19e0180e0
map.playerSpaces = [
    [3, 0],
    [4, 0],
    [3, 1],
